...
struct shl_cnr_link_t {
  ...
  uint32_t dwFlags;
  /* Offset of the NetName field (ANSI, NULL每terminated string) */
  uint32_t cbNetNameOffset;
  /* Offset of the DeviceName field (ANSI, NULL每terminated string) */
...
struct shl_cnr_linkw_t {
  ...
  /* Type of the network provider (WNNC_NET_* defined in winnetwk.h) */
  uint32_t dwNetworkProviderType;
  /* Offset of the NetNameUnicode field (Unicode, NULL每terminated string) */
  uint32_t cbNetNameUnicodeOffset;
  /* Offset of the DeviceNameUnicode field (Unicode, NULL每terminated string) */
