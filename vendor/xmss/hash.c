...
static int core_hash(const xmss_params *params, unsigned char *out,
 ...
 */
int prf(const xmss_params *params, unsigned char *out,
        const unsigned char in[32], const unsigned char *key) {
...
int hash_message(const xmss_params *params, unsigned char *out,
                 ...
                 unsigned long long idx, unsigned char *m_with_prefix,
 ...
 */
int thash_h(const xmss_params *params, unsigned char *out,
            const unsigned char *in, const unsigned char *pub_seed,
            uint32_t addr[8]) {
...
int thash_f(const xmss_params *params, unsigned char *out,
            const unsigned char *in, const unsigned char *pub_seed,
            uint32_t addr[8]) {
