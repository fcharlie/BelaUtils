...
/*{\rtf1*/
status_t inquisitive_rtfinternal(bela::MemView mv, particulars_result &pr) {
...
status_t explore_docs(bela::MemView mv, particulars_result &pr) {
  ...
  constexpr const byte_t pptMagic[] = {0xD0, 0xCF, 0x11, 0xE0, 0xA1, 0xB1, 0x1A, 0xE1, 0x00, 0x00, 0x00, 0x00};
  ...
  if (inquisitive_rtfinternal(mv, pr) == Found) {
    return Found;
  }
